...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["product_media_id"], ["product_media.id"], ondelete="CASCADE"),
    ...
    op.create_index(op.f("ix_order_item_delivered"), "order_item", ["delivered"], unique=False)
    op.create_index(op.f("ix_order_item_tracking_id"), "order_item", ["tracking_id"], unique=False)
    op.create_table(
        "payments",
